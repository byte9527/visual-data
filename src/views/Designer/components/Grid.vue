...
export default {
  ...
  methods: {
    ...
    repaint() {
      ...
      let x = 0;
      let y = 0;
      const { ySpace, xSpace, colNum, paddingY, paddingX } = this.layout;
      const { width, height } = this;

      const cellWidth = (width - xSpace * (colNum - 1) - paddingX * 2) / colNum;
      const cellHeight = this.layout.cellHeight;
